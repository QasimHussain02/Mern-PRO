...
const NewRideAvailableCard = ({ rideRequest, onIgnore, onAccept }) => {
  return (
    <motion.div
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span className="rounded-full bg-white/[0.05] px-2.5 py-1 text-[10px] font-semibold text-white">
      ...
      <div className="mt-3 grid grid-cols-2 gap-2">
        <button
          onClick={onIgnore}
          className="rounded-xl border border-white/[0.08] bg-transparent px-3 py-2.5 text-sm font-medium text-gray-300 transition-colors hover:bg-white/[0.04] cursor-pointer"
        >
          Ignore
        </button>
        <button
...
export default NewRideAvailableCard;
